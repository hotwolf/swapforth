\ ###############################################################################
\ # Swapforth N1 Port - Nucleus                                                 #
\ ###############################################################################
\ # Description:                                                                #
\ #    This file contains the minimum set of non-immediate word definitions to  #
\ #    Swapforth on the N1 processor.                                           #
\ #    The implementation has been derived from the J1a nucleus:                #
\ #                                                                             #
...
\ #    >                                                             <          #
\ #    >  The code here is Forth-like assembler code.	             <          #
...
\ #      - Initial release, derived from the J1a nucleus                        #
\ ###############################################################################

header 1+       :noname     1+          ;
header negate   :noname     negate      ;
header 1-       :noname     1-          ;
header 0=       :noname     0=          ;
header cell+    :noname     cell+       ;
...
header false    :noname     false       ;
header true     :noname     true        ;
header rot      :noname     rot         ;
header -rot     :noname     -rot        ;
header tuck     :noname     tuck        ;
header 2drop    :noname     2drop       ;
header ?dup     :noname     ?dup        ;

header 2dup     :noname     2dup        ;
header +!       :noname     +!          ;
header 2swap    :noname     2swap       ;
header 2over    :noname     2over       ;

header min      :noname     min         ;
header max      :noname     max         ;
